...
<div class="card">
    <div class="card-header bg-primary">
        <a href="#" data-petugas="add" class="btn btn-outline-light" data-target="#modalPetugas" data-toggle="modal"><i class="fas fa-fw fa-solid fa-user-plus"></i>Tambah Data Petugas</a>
    </div>
    <div class=""card-body>
